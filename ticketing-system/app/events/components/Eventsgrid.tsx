...
function EventCard({ event, index }: { event: RealEvent; index: number }) {
    ...
    const demandPercent = event.totalCapacity > 0 
            ...
            >
                ...
                <div className="relative overflow-hidden aspect-video">
                    ...
                    <div className="absolute bottom-3 left-3 flex items-center gap-1.5">
                        ...
                        <span className="text-[10px] font-bold text-white/90">{formatDate(event.startDate)}</span>
                    </div>
                </div>
                ...
                <div className="p-4">
                    ...
                    <div className="flex items-center gap-1.5 text-zinc-500 mb-4">
                        ...
                        <span className="text-xs font-medium truncate">{event.location}{event.city ? `, ${event.city}` : ''}</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-lg font-black text-zinc-950">{getPriceDisplay()}</p>
                        </div>
